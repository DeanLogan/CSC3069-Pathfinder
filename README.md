...
This project originated during my final year at university as a collaborative effort for the CSC3069 module. The team successfully completed the project, and the original repository is accessible [here](https://github.com/KyleMcComb/Pathfinder).

Additionally, you can explore the prototype developed for this system as part of the companion module CSC3068 [here](https://github.com/DeanLogan/CSC3068-Pathfinder-Prototype).

The corresponding reports that were submitted for CSC3069 that relate to this module can be found in the reports folder.
